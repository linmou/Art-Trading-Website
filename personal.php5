<?php include 'php_function.inc.php5'; ?>
...
<header>
    ...
    <ul>
        <li>
            <p style="display:inline-block">欢迎 </p><a href="xxx"><strong>小柒</strong></a>
        </li>
        <li>
...
<div class="nav">
    <ul>
        <li><a href="HomePage2.html">首页</a></li>
        <li><a href="search2.html">搜索</a></li>
        <li><a href="details2.html">购物车</a></li>
    </ul>
    <div class="search">
